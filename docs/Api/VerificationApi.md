# FirstData\FirstApi\Client\VerificationApi
...
$accountVerificationRequest = new \FirstData\FirstApi\Client\Model\AccountVerificationRequest(); // \FirstData\FirstApi\Client\Model\AccountVerificationRequest | Accepted request type: PaymentCardVerificationRequest and PaymentTokenVerificationRequest.
...
try {
    $result = $apiInstance->verifyAccount($contentType, $clientRequestId, $apiKey, $timestamp, $accountVerificationRequest, $messageSignature, $region);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling VerificationApi->verifyAccount: ', $e->getMessage(), PHP_EOL;
}
?>
```
 ...
 **accountVerificationRequest** | [**\FirstData\FirstApi\Client\Model\AccountVerificationRequest**](../Model/AccountVerificationRequest.md)| Accepted request type: PaymentCardVerificationRequest and PaymentTokenVerificationRequest. |
...
try {
    ...
    echo 'Exception when calling VerificationApi->verifyCard: ', $e->getMessage(), PHP_EOL;
}
?>
```
