...
class AuthenticationApi
{
     ...
     */
    public function authenticationAccessTokensPost($contentType, $clientRequestId, $apiKey, $timestamp, $messageSignature = null)
    {
        list($response) = $this->authenticationAccessTokensPostWithHttpInfo($contentType, $clientRequestId, $apiKey, $timestamp, $messageSignature);
        return $response;
    }
     ...
     */
    public function authenticationAccessTokensPostWithHttpInfo($contentType, $clientRequestId, $apiKey, $timestamp, $messageSignature = null)
    {
        $request = $this->authenticationAccessTokensPostRequest($contentType, $clientRequestId, $apiKey, $timestamp, $messageSignature);
     ...
     */
    public function authenticationAccessTokensPostAsync($contentType, $clientRequestId, $apiKey, $timestamp, $messageSignature = null)
    {
        return $this->authenticationAccessTokensPostAsyncWithHttpInfo($contentType, $clientRequestId, $apiKey, $timestamp, $messageSignature)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function authenticationAccessTokensPostAsyncWithHttpInfo($contentType, $clientRequestId, $apiKey, $timestamp, $messageSignature = null)
    {
        $returnType = '\FirstData\FirstApi\Client\Model\AccessTokenResponse';
        $request = $this->authenticationAccessTokensPostRequest($contentType, $clientRequestId, $apiKey, $timestamp, $messageSignature);
     ...
     */
    protected function authenticationAccessTokensPostRequest($contentType, $clientRequestId, $apiKey, $timestamp, $messageSignature = null)
    {
