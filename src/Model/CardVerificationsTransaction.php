...
/**
 * CardVerificationsTransaction Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class CardVerificationsTransaction implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CardVerificationsTransaction';
     ...
     * Sets storeId
     *
     * @param string|null $storeId Optional outlet ID for clients that support multiple store in the same app
     *
     * @return $this
     */
    public function setStoreId($storeId)
    {
        if (!is_null($storeId) && (mb_strlen($storeId) > 20)) {
            throw new \InvalidArgumentException('invalid length for $storeId when calling CardVerificationsTransaction., must be smaller than or equal to 20.');
        }
