...
class CardVerificationsTransaction implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CardVerificationsTransaction';
     ...
     * Sets storeId
     *
     * @param string $storeId Optional Outlet ID for clients that support multiple store in the same app
     *
     * @return $this
     */
