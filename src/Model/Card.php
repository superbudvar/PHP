...
class Card implements ModelInterface, ArrayAccess
{
     ...
     * Sets taToken
     *
     * @param string|null $taToken TransArmor Token value. Either the ta token fields or card number field must contain a value.
     *
     * @return $this
     */
     ...
     * Sets expDate
     *
     * @param string|null $expDate Payment method expiration date. Format is MMCCYY.
     *
     * @return $this
     */
