...
class Secure3DAuthenticationResponseParams implements ModelInterface, ArrayAccess
{
     ...
     * Sets cReq
     *
     * @param string|null $cReq The CReq message initiates cardholder interaction in a 3DS 2.1 challenge flow and carries authentication data from the cardholder.
     *
     * @return $this
     */
