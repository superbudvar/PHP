...
class CarRental implements ModelInterface, ArrayAccess
{
    ...
    public function valid()
    {
        ...
        if (strlen($this->container['agreementNumber']) > 20) {
            return false;
        }
        if (strlen($this->container['renterName']) > 20) {
            return false;
        }
        if (strlen($this->container['returnCity']) > 20) {
            return false;
        }
        if (strlen($this->container['rentalClassId']) > 6) {
            return false;
        }
        return true;
    }
    ...
    {
        if (!is_null($agreementNumber) && (strlen($agreementNumber) > 20)) {
    ...
    {
        if (!is_null($renterName) && (strlen($renterName) > 20)) {
    ...
    {
        if (!is_null($returnCity) && (strlen($returnCity) > 20)) {
    ...
    {
        if (!is_null($rentalClassId) && (strlen($rentalClassId) > 6)) {
     ...
     * Gets extraCharges
     *
     * @return \FirstData\FirstApi\Client\Model\CarRentalExtraCharges[]
     */
     ...
     * Sets extraCharges
     *
     * @param \FirstData\FirstApi\Client\Model\CarRentalExtraCharges[] $extraCharges extraCharges
     *
     * @return $this
     */
