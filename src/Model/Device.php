...
class Device implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'deviceType' => 'string',
        'deviceId' => 'string',
        'networks' => '\FirstData\FirstApi\Client\Model\DeviceNetworks[]',
        'latitude' => 'float',
        'longitude' => 'float',
        'imei' => 'string',
        'model' => 'string',
     ...
     * Gets networks
     *
     * @return \FirstData\FirstApi\Client\Model\DeviceNetworks[]|null
     */
     ...
     * Sets networks
     *
     * @param \FirstData\FirstApi\Client\Model\DeviceNetworks[]|null $networks networks
     *
     * @return $this
     */
     ...
     * Sets imei
     *
     * @param string|null $imei The device's International Mobile Equipment Identity (IMEI) as described in IETFs RFC7254.
     *
     * @return $this
     */
