...
class StoredCredential implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['referencedSchemeTransactionId']) && (mb_strlen($this->container['referencedSchemeTransactionId']) > 40)) {
     ...
     *
     * @param string|null $referencedSchemeTransactionId The transaction ID received from schemes for the initial transaction. Required if sequence is 'SUBSEQUENT'.
     *
     * @return $this
     */
    public function setReferencedSchemeTransactionId($referencedSchemeTransactionId)
    {
        if (!is_null($referencedSchemeTransactionId) && (mb_strlen($referencedSchemeTransactionId) > 40)) {
