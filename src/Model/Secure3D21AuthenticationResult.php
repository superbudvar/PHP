 ...
 *
 * @category Class
 * @description Submit the result of the authentication managed outside of the gateway for a 3-D Secure 2.1 scheme. For more convenient usage without implementing 3-D Secure yourself see \&quot;authenticationRequest\&quot; section.
 * @package  FirstData\FirstApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class Secure3D21AuthenticationResult extends Authentication 
{
     ...
     * Sets transactionId
     *
     * @param string|null $transactionId The response transaction ID. Only applicable to MasterCard.
     *
     * @return $this
     */
