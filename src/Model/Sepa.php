 ...
 *
 * @category Class
 * @description The payment object for SEPA DD. The iban, billing_address.name and country elements are required for this payment type.
 * @package  FirstData\FirstApi\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Sepa implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Sepa';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((strlen($this->container['iban']) > 34)) {
     ...
     * Sets country
     *
     * @param string $country Country of residence of the payer using the ISO 3166 standard (http://en.wikipedia.org/wiki/ISO_3166)
     *
     * @return $this
     */
