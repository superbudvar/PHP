...
class InstallmentOptions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InstallmentOptions';
    ...
    public function valid()
    {
        ...
        if ($this->container['numberOfInstallments'] > 99) {
            return false;
        }
        if ($this->container['numberOfInstallments'] < 1) {
            return false;
        }
        if ($this->container['installmentDelayMonths'] > 99) {
            return false;
        }
        if ($this->container['installmentDelayMonths'] < 1) {
            return false;
        }
        return true;
    }
     ...
     *
     * @param int $numberOfInstallments Number of installments for a Sale transaction if the customer pays the total amount in multiple transactions
     *
     * @return $this
     */
     ...
     *
     * @param bool $installmentsInterest Indicates whether the installment interest amount has been applied. Possible values are \"yes\" or \"no\".
     *
     * @return $this
     */
     ...
     *
     * @param int $installmentDelayMonths The number of months the first installment payment will be delayed
     *
     * @return $this
     */
