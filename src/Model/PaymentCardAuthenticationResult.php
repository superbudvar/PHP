...
class PaymentCardAuthenticationResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentCard_authenticationResult';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['payerAuthenticationResponse']) && !in_array($this->container['payerAuthenticationResponse'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
     ...
     * Sets type
     *
     * @param string|null $type Type of authentication result. For example, 3-D Secure.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $payerAuthenticationResponse Payer authentication result from Payment Authentication Response (PaRes)
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getPayerAuthenticationResponseAllowableValues();
        if (!is_null($payerAuthenticationResponse) && !in_array($payerAuthenticationResponse, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'payerAuthenticationResponse', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     *
     * @param string|null $authenticationValue Cardholder Authentication Verification Value (CAVV)
     *
     * @return $this
     */
     ...
     * Sets xid
     *
     * @param string|null $xid Authentication ID
     *
     * @return $this
     */
