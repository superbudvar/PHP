...
class MerchantLocationMerchantAddress implements ModelInterface, ArrayAccess
{
    ...
    public function setStreet($street)
    {
        ...
        if ((!preg_match("/^(?!\\s*$).+/", $street))) {
            throw new \InvalidArgumentException("invalid value for $street when calling MerchantLocationMerchantAddress., must conform to the pattern /^(?!\\s*$).+/.");
        }
    ...
    public function setCountry($country)
    {
        ...
        if ((!preg_match("/^(?!\\s*$).+/", $country))) {
            throw new \InvalidArgumentException("invalid value for $country when calling MerchantLocationMerchantAddress., must conform to the pattern /^(?!\\s*$).+/.");
        }
    ...
    public function setZipPostalCode($zipPostalCode)
    {
        ...
        if ((!preg_match("/^(?!\\s*$).+/", $zipPostalCode))) {
            throw new \InvalidArgumentException("invalid value for $zipPostalCode when calling MerchantLocationMerchantAddress., must conform to the pattern /^(?!\\s*$).+/.");
        }
