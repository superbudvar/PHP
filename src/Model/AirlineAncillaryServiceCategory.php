...
class AirlineAncillaryServiceCategory implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string|null $serviceCategory Identifies the service purchased in the transaction if not a base ticket
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getServiceCategoryAllowableValues();
        if (!is_null($serviceCategory) && !in_array($serviceCategory, $allowedValues, true)) {
