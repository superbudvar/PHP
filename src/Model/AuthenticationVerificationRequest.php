...
/**
 * AuthenticationVerificationRequest Class Doc Comment
 *
 * @category Class
 * @description Provides shared fields for all AuthenticationVerificationRequest types. Provides shared fields for all PrimaryTransaction request types. Abstract class, do not use this class directly, use one of its children.
 * @package  FirstData\FirstApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AuthenticationVerificationRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuthenticationVerificationRequest';
    ...
    public function setStoreId($storeId)
    {
        if (!is_null($storeId) && (mb_strlen($storeId) > 20)) {
            throw new \InvalidArgumentException('invalid length for $storeId when calling AuthenticationVerificationRequest., must be smaller than or equal to 20.');
        }
     ...
     * Sets requestType
     *
     * @param string $requestType Object name of the authentication verification request.
     *
     * @return $this
     */
