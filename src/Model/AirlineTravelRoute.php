 ...
 *
 * @category Class
 * @description Object holding additional information about the route
 * @package  FirstData\FirstApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AirlineTravelRoute implements ModelInterface, ArrayAccess
{
     ...
     * Sets stopoverType
     *
     * @param string|null $stopoverType Indicates whether the route is direct or not.
     *
     * @return $this
     */
     ...
     * Sets departureTax
     *
     * @param float|null $departureTax departureTax
     *
     * @return $this
     */
