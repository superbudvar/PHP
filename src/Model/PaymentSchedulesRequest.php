 ...
 *
 * @category Class
 * @description Request to create a gateway schedule.
 * @package  FirstData\FirstApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PaymentSchedulesRequest implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string|null $referencedOrderId Order ID used to create recurring payment from existing transaction.
     *
     * @return $this
     */
     ...
     * Sets startDate
     *
     * @param \DateTime|null $startDate Date of mandate signature.
     *
     * @return $this
     */
     ...
     *
     * @param int|null $numberOfPayments Number of times the recurring pament will process.
     *
     * @return $this
     */
