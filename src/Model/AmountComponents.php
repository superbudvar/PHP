 ...
 *
 * @category Class
 * @description Model for transaction amounts with multiple components.
 * @package  FirstData\FirstApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AmountComponents implements ModelInterface, ArrayAccess
{
     ...
     * Sets convenienceFee
     *
     * @param float|null $convenienceFee Amount added for proccessing or handling fees, field must not be present in requests.
     *
     * @return $this
     */
