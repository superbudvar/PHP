 ...
 *
 * @category Class
 * @description Request authentication of the payment card to verify the cardholder and be eligible for liability shift. Provides shared fields for all Authentication request types. Abstract class, do not use this class directly, use one of its children.
 * @package  FirstData\FirstApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class Authentication implements ModelInterface, ArrayAccess
{
     ...
     * Sets requestType
     *
     * @param string $requestType Indicates what kind of authentication scheme the merchant wants to use on the card.
     *
     * @return $this
     */
