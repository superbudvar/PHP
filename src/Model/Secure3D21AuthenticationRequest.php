 ...
 *
 * @category Class
 * @description Request authentication of the payment card using the 3DS 2.1 URL redirect scheme.
 * @package  FirstData\FirstApi\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class Secure3D21AuthenticationRequest extends AuthenticationRequest 
{
     ...
     * Sets termURL
     *
     * @param string|null $termURL The result of the authentication will be sent to this URL. If not provided, a term URL will be dynamically generated.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $methodNotificationURL The 3DS method iframe and transaction ID will be sent here.
     *
     * @return $this
     */
