 ...
 *
 * @category Class
 * @description Certificate Signing Request (CSR) object
...
class Certificate implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['appLabel'] === null) {
            $invalidProperties[] = "'appLabel' can't be null";
        }
        if ($this->container['walletProvider'] === null) {
            $invalidProperties[] = "'walletProvider' can't be null";
        }
     ...
     * Sets value
     *
     * @param string $value The certificate that is registered in a Wallet Provider
     *
     * @return $this
     */
     ...
     * Sets appLabel
     *
     * @param string $appLabel The Application Label in the Wallet Provider setup
     *
     * @return $this
     */
     ...
     * Sets walletProvider
     *
     * @param string $walletProvider The wallet type of the CSR
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status The status of the CSR
     *
     * @return $this
     */
