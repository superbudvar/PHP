...
class ErrorDetails implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Error_details';
     ...
     * Sets field
     *
     * @param string $field The property or attribute associated with the error.
     *
     * @return $this
     */
     ...
     * Sets message
     *
     * @param string $message Information specific to a property or attribute.
     *
     * @return $this
     */
