...
class Amount implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'total' => 'float',
        'currency' => 'string',
        'components' => AmountComponents::class
    ];
     ...
     * Sets currency
     *
     * @param string $currency ISO 4217 (http://en.wikipedia.org/wiki/ISO_4217) currency code.
     *
     * @return $this
     */
     ...
     * Gets components
     *
     * @return \FirstData\ApiClient\Model\AmountComponents
     */
     ...
     * Sets components
     *
     * @param \FirstData\ApiClient\Model\AmountComponents $components components
     *
     * @return $this
     */
